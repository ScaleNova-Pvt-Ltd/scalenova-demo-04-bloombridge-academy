# Google Sheets Intake Architecture — Bloombridge Academy
...
- **Assigned Worksheet**: `Demo 4 - Education`

## 2. Standard 23-Column Schema
Each row in `Demo 4 - Education` is stored with 23 standardized columns:

1. **Submission ID**: Unique deterministic key (e.g. `SN-BLO-202609-1234`)
2. **Created At**: ISO-8601 UTC timestamp
3. **Demo ID**: `DEMO-04`
4. **Industry**: `Education & Training`
5. **Client Name**: `Bloombridge Academy`
...
17. **Source**: `Bloombridge Academy Website`
