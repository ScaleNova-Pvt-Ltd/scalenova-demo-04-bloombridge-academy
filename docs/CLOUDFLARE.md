# Cloudflare Workers Deployment Guide — Bloombridge Academy

## 1. Overview
Bloombridge Academy (`DEMO-04`) is engineered for sub-second global edge delivery via **Cloudflare Workers** with Static Assets.

- **Primary Custom Domain**: `https://demo4.scalenovasys.com`
- **Fallback URL**: `https://scalenova-demo-04-bloombridge-academy.<account>.workers.dev`
...
3. Select **Connect to Git** and choose the repository:
   `ScaleNova-Pvt-Ltd/scalenova-demo-04-bloombridge-academy`
...
2. Add custom domain: `demo4.scalenovasys.com`.
