...
| `demoId` | Demo ID | `custom_demo_id` | Data | e.g. `DEMO-04` |
| `submissionId` | Submission ID | `custom_submission_id` | Data | e.g. `SN-BLO-202609-1234` |
| `source` | Source | `source` | Select | "ScaleNova Demo — Education & Training" |
